...
CREATE INDEX IF NOT EXISTS idx_short_slot_requests_user_id ON short_slot_requests(user_id);
CREATE INDEX IF NOT EXISTS idx_short_slot_requests_status ON short_slot_requests(status);
CREATE INDEX IF NOT EXISTS idx_short_slot_requests_created_at ON short_slot_requests(created_at DESC);
