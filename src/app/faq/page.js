...
const faqs = [
  ...
  { q: '회원가입을 하면 어떤 장점이 있나요?', a: '회원가입하면 영구적으로 유지되는 단축 URL·텍스트를 만들 수 있습니다. 비회원 링크는 최대 1개월 후 만료되지만, 회원 URL·텍스트는 만료되지 않습니다. 파일 공유만 최근 3개월 미접속 시 자동 삭제됩니다. 대시보드에서 모든 링크를 관리하고 클릭 통계를 확인할 수 있습니다.' },
  { q: '파일 공유는 어떻게 하나요?', a: '메인 페이지 또는 대시보드에서 "파일 공유" 탭을 선택한 뒤 문서, 이미지, 압축파일(최대 5GB 지원)을 올리고 단축 코드를 정하면 됩니다. 3MB 이상 대용량 파일은 Cloudflare R2로 초고속 직접 업로드되며, 용량별 수명 주기 규칙에 따라 파일이 자동 삭제되어 용량 낭비와 개인정보 노출을 방지합니다.' },
  { q: '회원 파일 링크도 영구인가요?', a: '아니요. URL·텍스트와 달리 파일 공유만 최근 3개월간 접속이 없으면 링크와 파일이 자동 삭제됩니다.' },
